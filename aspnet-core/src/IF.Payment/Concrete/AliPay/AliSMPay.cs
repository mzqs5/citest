...
namespace IF.Payment.Concrete.AliPay
{
    public class AliSMPay : PayBase
    {
        ...
        protected override PayRst Pay(QueryBase query)
        {
            ...
            sParaTemp.Add("anti_phishing_key", Submit.Query_timestamp(Payparam.Partner));
            sParaTemp.Add("exter_invoke_ip", PayHelp.GetUserIP());
            ...
            Log.log("AliPayLogger", "sParaTemp:" + JsonUtil.ToJson(sParaTemp));
            //建立请求
